import 'package:bnidark/AjoutTerrain.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Terrain à vendre'.tr),
        actions: <Widget>[
...
class _DSState extends State<DS> {
  final Stream<QuerySnapshot> _exper =
      FirebaseFirestore.instance.collection('tterain').snapshots();
  void Addetoil(String docid, int like) {
    var newetiol = like + 1;
    try {
      FirebaseFirestore.instance.collection('tterain').doc(docid).update({
        'likes': newetiol,
