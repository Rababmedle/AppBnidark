import 'package:bnidark/AjoutSoc.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('matériaux de construction'.tr),
        actions: <Widget>[
...
class _DSState extends State<DS> {
  final Stream<QuerySnapshot> _exper =
      FirebaseFirestore.instance.collection('Mwad-lbina').snapshots();
  void Addetoil(String docid, int like) {
    var newetiol = like + 1;
    try {
      FirebaseFirestore.instance.collection('Mwad-lbina').doc(docid).update({
        'likes': newetiol,
